...
var toEqual = expect.toEqual;

var createScheduleList = function createScheduleList(_ref) {
  var _ref$minTime = _ref.minTime,
      minTime = _ref$minTime === void 0 ? '00:00:00' : _ref$minTime,
      _ref$maxTime = _ref.maxTime,
      maxTime = _ref$maxTime === void 0 ? '23:59:59' : _ref$maxTime,
      step = _ref.step;
  var min = moment(minTime, 'HH:mm:ss'); //.format('hh:mm:ss')

  var max = moment(maxTime, 'HH:mm:ss').add(1, 'm'); //.format('hh:mm:ss')

  var arr = [];

  while (min.isSameOrBefore(max)) {
    arr.push(min.format('HH:mm:ss')); //str = str.concat(minTime.format('kk:mm:ss'),',')x
...
var date = moment('2019-11-02', 'YYYY-MM-DD');
console.log(JSON.stringify(date));
console.log(JSON.stringify(moment()));
var time = moment('22:22:22', 'HH:mm:ss');
console.log(JSON.stringify(time));
console.log(moment().isBefore(time));
console.log(moment('2019-02-02').isBefore(moment())); //console.log(moment('00:11:22','HH:mm:ss').isBefore('22:22:22','HH:mm:ss'))
